...
function AvailableBooks() {
    return (
        <section className="flex flex-col items-center justify-center w-full h-[750px] sm:h-[750px]">
                        ...
                        <CarouselContent className="-ml-1">
                            {books.map((book, index) => (
                                <CarouselItem key={index} className="pl-1 md:basis-1/2 lg:basis-1/3">
                                    <div className="p-4">
                                        <Card
                                            className="h-full hover:shadow-lg transition-shadow duration-300 cursor-pointer border-gray-100">
                                            <CardContent className="flex aspect-square items-center justify-center">
                                                <Image src={`/book-covers/book${index + 1}.jpg`}
                                                       alt={`Book Cover ${book.title}`} width={200} height={250}
