...
// Read-only props for the CustomerDashboardClient component to ensure immutability.
interface CustomerDashboardClientProps {
  readonly userProfile: UserProfile;
  readonly userEmail: string;
  readonly locale: string; // initial locale from server
}
  ...
  useEffect(() => {
    ...
    const loadTranslations = async () => {
      try {
        ...
        if (mounted) setT(() => translations.t);
      } catch (error) {
